    ...
    <div class="span10">
        ...
        <div class="tab-content tabsContent">
            ...
            <div class="tab-pane fade" id="personalizar">
                <p>Sistema de cadastro de multiplos campos para personalizar um produto</p>
                <p>Exemplo: Uma camisa que tenha vários tamanhos, ou cores, ou um campo para escrever um texto para colocar nela.</p>
            </div>
